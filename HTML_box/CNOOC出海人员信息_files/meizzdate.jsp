...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#4977B4 bgcolor=#EEEEEE >';
strFrame+='  <tr ><td width=142 height=23  bgcolor=#FFFFFF><table border=0 cellspacing=1 cellpadding=0 width=140  height=23>';
strFrame+='      <tr align=center ><td width=16 align=center><input  type=button class=button value="< " title="向前翻 1 月" onclick="parent.meizzPrevM()" ';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px;cursor: hand;font-weight: bold;">';
...
strFrame+='        <td width=16 bgcolor=#9496E1 align=center><input  type=button class=button value=" >" onclick="parent.meizzNextM()" ';
strFrame+='             onfocus="this.blur()" title="向后翻 1 月" class=button style="font-size: 12px;font-weight: bold; height: 20px;cursor: hand;"></td></tr>';
...
strFrame+='<tr  align=center valign=bottom><td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >日</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >一</td><td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >二</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >三</td><td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >四</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >五</td><td style="font-size:12px;color:#FFFFFF;font-weight: bold;" >六</td></tr>';
strFrame+='</table></td></tr>';
...
function setday(tt,obj) //主调函数
{
	...
	var twidth  = tt.clientWidth;  //TT控件本身的高
	var tleft = tt.offsetLeft;    //TT控件的定位点宽
	var ttyp  = tt.type;          //TT控件的类型

	var bdscrollTop = document.body.scrollTop;
	var bdscrollLeft = document.body.scrollLeft;

	while (tt = tt.offsetParent){ttop+=tt.offsetTop; tleft+=tt.offsetLeft;}


	if((ttop-bdscrollTop)+thei+211>document.body.offsetHeight)
		dads.top=(ttyp=="image")? ttop-211: ttop-211-2;
	else
		dads.top= (ttyp=="image")? ttop+thei : ttop+thei+6;

	if((tleft-bdscrollLeft)+150>document.body.offsetWidth)
		dads.left=bdscrollLeft+document.body.offsetWidth-150;
	else
		dads.left=tleft;	
...
function meizzToday()  //Today Button
  {
    ...
    if (dd<10)dd="0"+dd;
    if(outObject){
		outObject.value=meizzTheYear + "-" + mm + "-" + dd;
    }
    closeLayer();
  }
