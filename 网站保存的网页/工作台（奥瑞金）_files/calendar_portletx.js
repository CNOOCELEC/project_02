...
define( function(require, exports, module) {
	...
	var CalendarPortlet = base.Container.extend({
		...
		startup : function(){
			...
			if(!window.calendarPortletOpen){
				var self = this;
				window.calendarPortletOpen = function(url,method,type){
					...
					self.openCalendarDialog(url,method,type);
				};
			}
		},
			...
			if(this.datas && this.datas[currentStr] && this.datas[currentStr].length > 0){
				for(var i = 0;i < this.datas[currentStr].length; i++){
					...
					var date = clang['kmCalendarMain.allDay'],
						labelName = data.labelName ? data.labelName : clang['kmCalendar.nav.title'];
					if(!data.allDay){
